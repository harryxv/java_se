...
public class IOStream {
    ...
    public String getResourcesPath(String file) {
    ...
    public void copyBytes() throws IOException {
        ...
        try (FileInputStream in = new FileInputStream(getResourcesPath("testcontent.txt"));
             BufferedInputStream bis = new BufferedInputStream(in);
             FileOutputStream out = new FileOutputStream(getResourcesPath("testcontent_copy.txt"));
